...
export const environmentDefaults: Record<RuntimeEnvironment, EnvironmentSchemaDefaults> = {
	[RuntimeEnvironment.Development]: {
		...
		LLM_API_BASE_URL: ENV_PLACEHOLDERS.LLM_API_BASE_URL,
		HEADER_APP_TITLE: ENV_PLACEHOLDERS.HEADER_APP_TITLE,
		HEADER_APP_URL: ENV_PLACEHOLDERS.HEADER_APP_URL,
		REPO_FORK_OWNER: ENV_PLACEHOLDERS.REPO_FORK_OWNER,
		REPO_FORK_NAME: ENV_PLACEHOLDERS.REPO_FORK_NAME,
		REPO_UPSTREAM_OWNER: ENV_PLACEHOLDERS.REPO_UPSTREAM_OWNER,
		REPO_UPSTREAM_NAME: ENV_PLACEHOLDERS.REPO_UPSTREAM_NAME,
		LLM_MODEL: ENV_PLACEHOLDERS.LLM_MODEL,
		BATCH_SIZE: ENV_PLACEHOLDERS.BATCH_SIZE,
		TARGET_LANGUAGE: ENV_PLACEHOLDERS.TARGET_LANGUAGE,
		SOURCE_LANGUAGE: ENV_PLACEHOLDERS.SOURCE_LANGUAGE,
		GH_TOKEN: ENV_PLACEHOLDERS.GH_TOKEN,
		LLM_API_KEY: ENV_PLACEHOLDERS.LLM_API_KEY,
		OPENAI_PROJECT_ID: ENV_PLACEHOLDERS.OPENAI_PROJECT_ID,
		GH_REQUEST_TIMEOUT: ENV_PLACEHOLDERS.GH_REQUEST_TIMEOUT,
		LOG_TO_CONSOLE: ENV_PLACEHOLDERS.LOG_TO_CONSOLE,
		MAX_TOKENS: ENV_PLACEHOLDERS.MAX_TOKENS,
		MIN_SUCCESS_RATE: ENV_PLACEHOLDERS.MIN_SUCCESS_RATE,
		MAX_RETRY_ATTEMPTS: ENV_PLACEHOLDERS.MAX_RETRY_ATTEMPTS,
		MAX_LLM_CONCURRENCY: ENV_PLACEHOLDERS.MAX_LLM_CONCURRENCY,
		MAX_GITHUB_CONCURRENCY: ENV_PLACEHOLDERS.MAX_GITHUB_CONCURRENCY,
	},
