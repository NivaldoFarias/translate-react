...
### How `"use memo"` marks functions for optimization {/_how-use-memo-marks_/}
...
### When to use `"use memo"` {/_when-to-use_/}

You should consider using `"use memo"` when:

#### You're using annotation mode {/_annotation-mode-use_/}
...
#### You're gradually adopting React Compiler {/_gradual-adoption_/}
...
### Working with different compilation modes {/_compilation-modes_/}
...
#### Annotation mode {/_annotation-mode-example_/}
...
#### Infer mode (default) {/_infer-mode-example_/}
...
### Verifying optimization {/_verifying-optimization_/}
