...
import type { UpstreamLocaleConfig } from "@/ci/domain/upstream/upstream-locale.schema";
import type { UpstreamShaVariableReader } from "@/ci/upstream/upstream-sha-variable.reader";

import { UpstreamShaPoller } from "@/ci/upstream/upstream-sha.poller";
